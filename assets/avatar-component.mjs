...
import { a } from "./helpers-06kgIPFz.js";
import { S as r } from "./constants-gifQEXQt.js";
...
class AvatarComponent extends HTMLElement {
  constructor() {
    var _a2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    super(), _classPrivateMethodInitSpec(this, _AvatarComponent_brand), _classPrivateFieldInitSpec(this, _a, new Map()), _classPrivateFieldInitSpec(this, _r, void 0), this, _assertClassBrand(_AvatarComponent_brand, this, _e).call(this, _a2), _classPrivateFieldSet(_r, this, this.attachShadow({
      mode: "closed"
    })), _classPrivateFieldGet(_r, this).innerHTML = "<div role=img><slot></slot></div>";
  }
  attributeChangedCallback(a) {
    if (!1 !== this.isConnected) switch (a) {
      case "href":
      case "target":
        _assertClassBrand(_AvatarComponent_brand, this, _t).call(this), _assertClassBrand(_AvatarComponent_brand, this, _s).call(this);
        break;
      case "size":
  ...
  connectedCallback() {
    _classPrivateFieldGet(_r, this).adoptedStyleSheets.push(t), _assertClassBrand(_AvatarComponent_brand, this, _i).call(this), _assertClassBrand(_AvatarComponent_brand, this, _t).call(this), _assertClassBrand(_AvatarComponent_brand, this, _s).call(this);
  }
}
_AvatarComponent = AvatarComponent;
function _e() {
  var a = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var r = _AvatarComponent.observedAttributes,
    e = Object.entries(a),
    t = e.filter(_ref => {
      var [a] = _ref;
      return !1 === r.includes(a);
    });
  e.filter(_ref2 => {
    var [a] = _ref2;
    return r.includes(a);
    ...
    var [a, r] = _ref3;
    return this.setAttribute(a, r);
  }), t.length > 0 && console.warn("Unsupported attributes: \"".concat(t.map(_ref4 => {
    var [a] = _ref4;
    return a;
  }).join(", "), "\""));
}
function _i() {
  ...
  a ? (console.assert(_AvatarComponent.sizes.includes(a), "Wrong size: \"".concat(a, "\"")), _classPrivateGetter(_AvatarComponent_brand, this, _get_o).classList.add("s-" + a)) : _AvatarComponent.sizes.forEach(a => _classPrivateGetter(_AvatarComponent_brand, this, _get_o).classList.remove("s-" + a));
}
function _t() {
  ...
  if (r) {
    if (_classPrivateFieldGet(_a, this).has("link")) {
      var _a3 = _classPrivateFieldGet(_a, this).get("link");
      _a3.setAttribute("href", r), _a3.setAttribute("target", e);
    } else _classPrivateFieldGet(_a, this).set("link", a("a", {
...
function _s() {
  var r = this.getAttribute("img");
  r ? _classPrivateGetter(_AvatarComponent_brand, this, _get_p) ? _classPrivateGetter(_AvatarComponent_brand, this, _get_o).style.backgroundImage = "url(".concat(r, ")") : (_classPrivateFieldGet(_a, this).has("image") ? _classPrivateFieldGet(_a, this).get("image").setAttribute("src", r) : _classPrivateFieldGet(_a, this).set("image", a("img", {
    src: r
...
_defineProperty(AvatarComponent, "sizes", r);
