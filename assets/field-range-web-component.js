...
function _createComponent() {
    ...
    this.dataset, 'name') && elem.setAttribute('name', String(this.dataset.name));
    this.dataset, 'value') && elem.setAttribute('value', String(this.dataset.value));
    return elem;
}
...
function _createLabel() {
    ...
    this.dataset, 'label') && (elem.innerText = String(this.dataset.label));
    return elem;
}
