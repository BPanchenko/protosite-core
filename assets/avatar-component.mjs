...
import { S as a, a as r } from "./constants-BfgzLc0v.js";
...
function _t() {
  ...
  if (a) {
    if (_classPrivateFieldGet(_a, this).has("link")) {
      var _r2 = _classPrivateFieldGet(_a, this).get("link");
      _r2.setAttribute("href", a), _r2.setAttribute("target", e);
    } else _classPrivateFieldGet(_a, this).set("link", r("a", {
...
function _s() {
  ...
  a ? _classPrivateGetter(_AvatarComponent_brand, this, _get_p) ? _classPrivateGetter(_AvatarComponent_brand, this, _get_o).style.backgroundImage = "url(".concat(a, ")") : (_classPrivateFieldGet(_a, this).has("image") ? _classPrivateFieldGet(_a, this).get("image").setAttribute("src", a) : _classPrivateFieldGet(_a, this).set("image", r("img", {
    src: a
...
_defineProperty(AvatarComponent, "sizes", a);
