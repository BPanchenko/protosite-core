...
class LocalStorage extends Map {
	...
	constructor(
		props,
		{ name = getDefaultLocalStorageName(), createdKey = '__created__', updatedKey = '__updated__' } = {}
	) {
		super(props);
		this.name = name;
...
EventEmmiter.extend(LocalStorage.prototype);

export { getDefaultLocalStorageName, LocalStorage };
