...
class AvatarComponent extends HTMLElement {
    ...
    constructor() {
        super();
        _AvatarComponent_instances.add(this);
        _AvatarComponent_shadowRoot.set(this, undefined);
        _AvatarComponent_internals.set(this, this.attachInternals());
        __classPrivateFieldSet(this, _AvatarComponent_shadowRoot, initShadowRoot.call(this, {
            template,
            delegatesFocus: true,
        }), "f");
        __classPrivateFieldGet(this, _AvatarComponent_instances, "a", _AvatarComponent_states_get).add("--defined");
    }
    attributeChangedCallback(name, previous, current) {
        ...
        const $child = ['href', 'target', 'tabindex'].includes(name)
            ? __classPrivateFieldGet(this, _AvatarComponent_instances, "a", _AvatarComponent_$link_get)
            : ['alt', 'src'].includes(name)
                ? __classPrivateFieldGet(this, _AvatarComponent_instances, "a", _AvatarComponent_$image_get)
                : null;
        if ($child === null)
            return;
    ...
    connectedCallback() {
        __classPrivateFieldGet(this, _AvatarComponent_shadowRoot, "f").adoptedStyleSheets.push(styleSheet);
    }
}
_AvatarComponent_shadowRoot = new WeakMap(), _AvatarComponent_internals = new WeakMap(), _AvatarComponent_instances = new WeakSet(), _AvatarComponent_$link_get = function _AvatarComponent_$link_get() {
    return __classPrivateFieldGet(this, _AvatarComponent_shadowRoot, "f").getElementById('link');
}, _AvatarComponent_$image_get = function _AvatarComponent_$image_get() {
    const $element = __classPrivateFieldGet(this, _AvatarComponent_shadowRoot, "f").getElementById('image');
    if ($element === null)
        throw new Error('Image element not found but required!');
    return $element;
}, _AvatarComponent_states_get = function _AvatarComponent_states_get() {
    return __classPrivateFieldGet(this, _AvatarComponent_internals, "f").states;
};
AvatarComponent.observedAttributes = [
    'alt',
    'href',
    'src',
    'tabindex',
...
AvatarComponent.role = 'img';
AvatarComponent.tagName = 'c-avatar';
customElements.define(AvatarComponent.tagName, AvatarComponent);
const index = customElements.get(AvatarComponent.tagName);
