...
var i = t,
  o = "<figure class=\"".concat(t, "\"><slot></slot></figure>");
...
class AvatarComponent extends HTMLElement {
  ...
  connectedCallback() {
    _classPrivateFieldGet(_t, this).adoptedStyleSheets.push(a), _assertClassBrand(_AvatarComponent_brand, this, _i).call(this), _assertClassBrand(_AvatarComponent_brand, this, _s).call(this), _assertClassBrand(_AvatarComponent_brand, this, _r).call(this);
  }
}
...
function _s() {
  ...
  if (e) {
    ...
    } else _classPrivateFieldGet(_e, this).set("link", r("a", {
      href: e,
      target: t
...
function _r() {
  ...
  e ? _classPrivateGetter(_AvatarComponent_brand, this, _get_n) ? _classPrivateGetter(_AvatarComponent_brand, this, _get_o).style.backgroundImage = "url(".concat(e, ")") : (_classPrivateFieldGet(_e, this).has("image") ? _classPrivateFieldGet(_e, this).get("image").setAttribute("src", e) : _classPrivateFieldGet(_e, this).set("image", r("img", {
    src: e
...
_defineProperty(AvatarComponent, "sizes", s);
